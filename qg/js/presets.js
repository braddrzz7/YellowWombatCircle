      ...
      '$$Numbers up to 1000, Counting By, Place Values, Gropuing, Addition with Carrying, Subtraction with Borrowing': {
        ...
        '$$Multiplication and rounding$$': {
          ...
          'More single digit multiplication': {
            ...
            'Multiplying by 2 (doubling)':['math-forwardMultiplication',{termRanges:[[2,2],[1,10]]}],
            'Multiplying by 5':['math-forwardMultiplication',{termRanges:[[5,5],[1,10]]}],
            'Multiplying by 4 (double double)':['math-forwardMultiplication',{termRanges:[[4,4],[1,10]]}]
          },
          'Multiplication up to 10 x 10': {
            'Multiplying [0,10] x [0,10]':['math-forwardMultiplication',{termRanges:[[0,10],[0,10]]}],
            'Multiplying [2,9] x [2,9]':['math-forwardMultiplication',{termRanges:[[2,9],[2,9]]}]
          }
        }
